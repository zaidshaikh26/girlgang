        ...
        <header className={style.Header}>
            ...
            <nav className={style.Header_navigation}>
                <ul className={style.Header_navigation_items}>
                    ...
                    <li className={style.Header_navigation_item}>
                        <div role="button" className={style.Dropdown} data-testid="dropdown">
                            <Link to="/search"  className={style.Dropdown_link} >
                                ...
                                <div className={style.Dropdown_link_label} data-testid="dropdown-title">Search</div>
                                <svg className={`${style.IconV2} ${style.Dropdown_link_caret} ${style.IconV2__position_default} ${style.IconV2__display_inlineBlock}`} width="12" height="12" viewBox="0 0 16 16"><path d="M3.619 3.729h8.762a.75.75 0 0 1 .637 1.146l-4.381 7.042a.75.75 0 0 1-1.274 0L2.982 4.875a.75.75 0 0 1 .637-1.146z" fill="#2A2825" fillRule="evenodd"></path></svg>
                            </Link>
                        </div>
                    </li>
                    <li className={style.Header_navigation_item}>
                        <div role="button" className={style.Dropdown} data-testid="dropdown">
                            <Link to="/guide"  className={style.Dropdown_link} >
                                <div className={style.Dropdown_link_image}>
                                ...
                                <div className={style.Dropdown_link_label} data-testid="dropdown-title">Guides</div>
                                <svg className={`${style.IconV2} ${style.Dropdown_link_caret} ${style.IconV2__position_default} ${style.IconV2__display_inlineBlock}`} width="12" height="12" viewBox="0 0 16 16"><path d="M3.619 3.729h8.762a.75.75 0 0 1 .637 1.146l-4.381 7.042a.75.75 0 0 1-1.274 0L2.982 4.875a.75.75 0 0 1 .637-1.146z" fill="#2A2825" fillRule="evenodd"></path></svg>
                            </Link>
                        </div>
                    </li>
                    <li className={style.Header_navigation_item}>
                        <div role="button" className={style.Dropdown} data-testid="dropdown">
                            <Link to="/blog" target="_blank" className={style.Dropdown_link} >
                                <div className={style.Dropdown_link_image}>
                                ...
                                <div className={style.Dropdown_link_label} data-testid="dropdown-title">More</div>
                                <svg className={`${style.IconV2} ${style.Dropdown_link_caret} ${style.IconV2__position_default} ${style.IconV2__display_inlineBlock}`} width="12" height="12" viewBox="0 0 16 16"><path d="M3.619 3.729h8.762a.75.75 0 0 1 .637 1.146l-4.381 7.042a.75.75 0 0 1-1.274 0L2.982 4.875a.75.75 0 0 1 .637-1.146z" fill="#2A2825" fillRule="evenodd"></path></svg>
                            </Link>
                        </div>
                    </li>
                    <li className={style.Header_navigation_item}>
                        <button className={`${style.ButtonV2} ${style.ButtonV2__size_xs} ${style.ButtonV2__color_pink}`}><span className={style.ButtonV2_children}>Start</span></button>
                    </li>
                    <li>
                        <div className={style.Header_navigation_activity} role="button"><div className={style.Header_navigation__globalfeed}></div>
