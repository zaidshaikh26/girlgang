...
import normal1 from "../pages/images/normal.png"
import normal2 from "../pages/images/normal.svg"
import diamond from "../pages/images/diamond.png"
import fancy from "../pages/images/fancy.svg"
import purrstige from "../pages/images/purrstige.svg"
import specialedition from "../pages/images/specialedition.svg"
import exclusive from "../pages/images/exclusive.svg"
import buy from "../pages/images/buy.svg"
import eggplant from "../pages/images/eggplant.svg"
import egg from "../pages/images/egg.svg"
import eggplantCancel from "../pages/images/eggplant-cancel.svg"
import gen0 from "../pages/images/gen0.svg"
import gift from "../pages/images/gift.svg"
import eggCrack from "../pages/images/eggCrack.svg"
import offer from "../pages/images/offer.svg"
import searchActive from "../pages/images/searchActive.svg"
import paw from "../pages/images/paw.svg"
import press from "../pages/images/press.svg"
import kit from "../pages/images/kit.svg"
import paper from "../pages/images/paper.svg"
import logoKv from "../pages/images/logo-kv.svg"
...
export default function Topbar() {
    ...
    const [isDropOpen4, setIsDropOpen4] = useState(false);
        ...
        <header class="Header">
            ...
            <nav class="Header-navigation">
                <ul class="Header-navigation-items" >
                    <li class="Header-navigation-item" onMouseEnter={event => {setIsDropOpen1(true);}} onMouseLeave={event => {setIsDropOpen1(false);}}>
                        <div role="button" class="Dropdown" data-testid="dropdown">
                            ...
                            {isDropOpen1 ?
                            <ul class="Dropdown-content u-slide--up" data-testid="dropdown-content">
                                <li class="Dropdown-content-linkWrapper"><img src={normal1} alt=""/><a class="Dropdown-content-link" href="/catalogue">Catalogue</a></li>
                                <li class="Dropdown-content-linkWrapper"><img src={normal2} alt=""/><a class="Dropdown-content-link" href="/catalogue/cattributes">Cattributes</a></li>
                                <li class="Dropdown-content-linkWrapper"><img src={diamond} alt=""/><a class="Dropdown-content-link" href="/catalogue/mewtations">Mewtations</a></li>
                                <li class="Dropdown-content-linkWrapper"><img src={fancy} alt=""/><a class="Dropdown-content-link" href="/catalogue/fancy-cats">Fancies</a></li>
                                <li class="Dropdown-content-linkWrapper"><img src={purrstige} alt=""/><a class="Dropdown-content-link" href="/catalogue/purrstige">Purrstige</a></li>
                                <li class="Dropdown-content-linkWrapper"><img src={specialedition} alt=""/><a class="Dropdown-content-link" href="/catalogue/special-edition-cats">Special Edition</a></li>
                                <li class="Dropdown-content-linkWrapper"><img src={exclusive} alt=""/><a class="Dropdown-content-link" href="/catalogue/exclusive-cats">Exclusive</a></li>
                            </ul>
                            : ''}
                        </div>
                    </li>
                    <li class="Header-navigation-item" onMouseEnter={event => {setIsDropOpen2(true);}} onMouseLeave={event => {setIsDropOpen2(false);}}>
                        <div role="button" class="Dropdown" data-testid="dropdown">
                            ...
                            {isDropOpen2 ?
                            <ul class="Dropdown-content u-slide--up" data-testid="dropdown-content">
                                <li class="Dropdown-content-linkWrapper"><img src={buy} alt=""/><a class="Dropdown-content-link" href="/search?include=sale">For Sale</a></li>
                                <li class="Dropdown-content-linkWrapper"><img src={eggplant} alt=""/><a class="Dropdown-content-link" href="/search?include=sire">Siring</a></li>
                                <li class="Dropdown-content-linkWrapper"><img src={normal2} alt=""/><a class="Dropdown-content-link" href="/search?include=sale,sire,other">All Cats</a></li>
                                <li class="Dropdown-content-linkWrapper"><img src={egg} alt=""/><a class="Dropdown-content-link active" aria-current="page" href="/pregnant">Pregnant</a></li>
                                <li class="Dropdown-content-linkWrapper"><img src={eggplantCancel} alt=""/><a class="Dropdown-content-link" href="/resting">Resting</a></li>
                                <li class="Dropdown-content-linkWrapper"><img src={gen0} alt=""/><a class="Dropdown-content-link" href="/search?include=sale&amp;search=gen:0">Gen-0</a></li>
                                <li class="Dropdown-content-linkWrapper"><img src={gift} alt=""/><a class="Dropdown-content-link" href="/wrapped-kitties">Wrapped Kitties</a></li>
                            </ul>
                            : ''}
                        </div>
                    </li>
                    <li class="Header-navigation-item" onMouseEnter={event => {setIsDropOpen3(true);}} onMouseLeave={event => {setIsDropOpen3(false);}}>
                        <div role="button" class="Dropdown" data-testid="dropdown">
                            ...
                            {isDropOpen3 ?
                            <ul class="Dropdown-content u-slide--up" data-testid="dropdown-content">
                                <li class="Dropdown-content-linkWrapper"><img src={eggCrack} alt=""/><a class="Dropdown-content-link" href="/guide/getting-started">Getting Started</a></li>
                                <li class="Dropdown-content-linkWrapper"><img src={offer} alt=""/><a class="Dropdown-content-link" href="/guide/gas">Gas and Fees</a></li>
                                <li class="Dropdown-content-linkWrapper"><img src={gen0} alt=""/><a class="Dropdown-content-link" href="/guide/kitty-types">Kitty Types</a></li>
                                <li class="Dropdown-content-linkWrapper"><img src={searchActive} alt=""/><a class="Dropdown-content-link" href="/faq">FAQs</a></li>
                                <li class="Dropdown-content-linkWrapper"><img src={paw} alt=""/><a class="Dropdown-content-link" href="/kitten-class/breeding/introduction">Kitten Class</a></li>
                            </ul>
                            : ''}
                        </div>
                    </li>
                    <li class="Header-navigation-item" onMouseEnter={event => {setIsDropOpen4(true);}} onMouseLeave={event => {setIsDropOpen4(false);}}>
                        <div role="button" class="Dropdown" data-testid="dropdown">
                            ...
                            {isDropOpen4 ?
                            <ul class="Dropdown-content u-slide--up" data-testid="dropdown-content">
                                <li class="Dropdown-content-linkWrapper"><img src={press} alt=""/><a href="/blog" class="Dropdown-content-link" target="_blank">Blog</a></li>
                                <li class="Dropdown-content-linkWrapper"><img src={kit} alt=""/><a class="Dropdown-content-link" href="/about">About</a></li>
                                <li class="Dropdown-content-linkWrapper"><img src={paper} alt=""/><a class="Dropdown-content-link" href="/newsletter">Newsletter</a></li>
                                <li class="Dropdown-content-linkWrapper"><img src={logoKv} alt=""/><a class="Dropdown-content-link" href="/kittyverse">KittyVerse</a></li>
                            </ul>
                            : ''}
                        </div>
                    </li>
