...
export default function ExclusiveCats() {
  ...
  return (
    <main className="sc-dkPtRN KCyLCm">
        <div className="Catalogue">
            ...
            <h2 class="sc-gsDKAQ hfWOXG">Exclusive Cats</h2>
                        ...
                        <div class="SpecialKittyCard">
                            <div class="SpecialKittyCard-header">
                                <div class="SpecialKittyCard-header-row">
                                    <div>
                                        <div class="SpecialKittyCard-title">PepitoTheMascot {item.id}</div>
                                    </div>
                                </div>
                                <div class="SpecialKittyCard-header-row">
                                    <div class="SpecialKittyCard-txt">Exclusive</div>
                            ...
                            <div class="SpecialKittyCard-footer SpecialKittyCard-txt">
                                <span>Find a PepitoTheMascot</span>
